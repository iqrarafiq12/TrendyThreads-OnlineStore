...
import HijabMagnets from '@/app/page/HijabMagnets';
          ...
          <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
            ...
            <div className="flex-[1] py-3">
              ...
              <div className="text-[34px] font-semibold mb-2">
                MATTE MAGNET PINS SET
              </div>
              {/* PRODUCT SUBTITLES */}
              <div className="text-sm cursor-pointer mb-5">
                If you only need one magnet of each color, then our 4 piece
                magnetic matte pin set is just for you! The set includes: - One
                Black Matte - One White Matte - One Nude Matte - One Taupe Matte
                It's time ditch your old hijab pins, which only snag your
                hijabs. Featuring zinc alloy metal that is nickel free. -
                WARNING: CHOKING HAZARD—Small parts - Keep away from children
                and pets.
              </div>

              {/* PRODUCT PRICE */}
              <div className="text-lg font-semibold">Price: $5.00</div>
